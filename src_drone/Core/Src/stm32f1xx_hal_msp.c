...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = MPU_MS_SCL_Pin|MPU_MS_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MPU_MS_SCL_GPIO_Port, MPU_MS_SCL_Pin);

    HAL_GPIO_DeInit(MPU_MS_SDA_GPIO_Port, MPU_MS_SDA_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOA, CH3_Pin|CH4_Pin);

    HAL_GPIO_DeInit(GPIOB, CH5_Pin|CH6_Pin);
